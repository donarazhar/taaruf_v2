    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboardadmin">
                ...
                <div class="sidebar-brand-text mx-3">Ta'aruf <sup>v.2.0</sup></div>
            </a>
            ...
            <li
                ...
                <a class="nav-link {{ request()->is(['masterberita', 'masteryoutube', 'masterkaryawan']) ? 'collapsed' : '' }}"
                    ...
                    aria-expanded="{{ request()->is(['masterberita', 'masteryoutube', 'masterkaryawan']) ? 'true' : 'false' }}"
                    aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Master Data</span>
                </a>
                <div id="collapseTwo"
                    class="{{ request()->is(['masterberita', 'masteryoutube', 'masterkaryawan']) ? 'collapse show' : 'collapse' }}"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Inputan</h6>
                        <a class="collapse-item {{ request()->is(['masterberita']) ? 'active' : '' }}"
                            href="/masterberita">Artikel & Berita</a>
                        <a class="collapse-item {{ request()->is(['masteryoutube']) ? 'active' : '' }}"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ $datauser->name }}</span>
                                <img class="img-profile rounded-circle" src="{{ asset('assets/img/logo.png') }}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Direktorat Dakwah & Sosial YPI Al Azhar</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/proseslogoutadmin">Logout</a>
                </div>
            </div>
        </div>
    </div>
