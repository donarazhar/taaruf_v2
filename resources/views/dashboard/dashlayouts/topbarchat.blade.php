    ...
    <div class="container">
        ...
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="chat-user--info d-flex align-items-center">
                <!-- Back Button-->
                <div class="back-button"><a href="/progress"><svg width="32" height="32" viewBox="0 0 16 16"
                ...
                <div class="user-thumbnail-name">
                    ...
                    <img src="{{ !empty($path) ? url($path) : asset('assets/img/' . $defaultAvatar) }}" alt="avatar"
                        class="user-thumbnail-name {{ $karyawan->jenkel === 'pria' ? '' : 'img-fluid' }}">
                    <div class="info ms-1">
                        <p>{{ $karyawan->nama }}</p><span class="active-status">{{ $karyawan->nip }}</span>
                    </div>
                </div>
            </div>
        </div>
